...
namespace Assets.Code.Ads
{
    public class RewardedAdsButton : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener, EventObserver
    {
        ...
        private string _spinWheelReward = "BallionRewardedFortuneWheel";
        private string _rewardMultiplierX3 = "BallionRewardedVictoryX3";
        private string _gameOverExtraLife = "BallionRewardedGameOverExtra";
