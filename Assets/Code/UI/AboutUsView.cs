...
namespace Assets.Code.UI
{
    public class AboutUsView : MonoBehaviour
    {
        ...
        {
            Application.OpenURL("https://www.privacypolicies.com/live/4693d805-4d8b-42a8-9715-b9e9e1296bff");
        }
        ...
        private void CheckForInnAppReview()
        {
            if (Application.platform == RuntimePlatform.Android)
            {
                ...
                {
                    Application.OpenURL("https://play.google.com/store/apps/details?id=com.BlueScorpioStudio.Ballion");
                }
            }
        }
